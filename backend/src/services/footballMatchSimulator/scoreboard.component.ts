          ...
          if (Math.random() < this.homeTeamPotentialFouls / 90) {
            ...
            if (Math.random() < 1 / 7) {
              ...
              if (homePlayerCautioned.yellowCards.yellowCardsNumber == 1) {
                ...
                let indexOfCautionedPlayer =
                  this.homeTeamStartingLineup.indexOf(homePlayerCautioned);
                this.homeTeamStartingLineup.splice(indexOfCautionedPlayer, 1);
                // decrease relative strength due to man disadvantage
                this.homeRelativeStrength =
                  this.homeRelativeStrength - this.homeRelativeStrength * 0.09;
                // decrease or increase morale after red card (50/50%)
                if (Math.random() > 0.5) {
                  this.homeTeamMorale =
                    this.homeTeamMorale - this.homeTeamMorale * 0.15;
                } else {
                  this.homeTeamMorale =
                    this.homeTeamMorale + this.homeTeamMorale * 0.15;
                }
              ...
              if (Math.random() < 1 / 500) {
                /* should be 500 */ // choose random player from home team squad who received straight red
                let homePlayerStraightRed =
                  this.homeTeamStartingLineup[
                    Math.round(
                      Math.random() * (this.homeTeamStartingLineup.length - 1)
                    )
                ...
                let indexOfPlayerStraightRed =
                  this.homeTeamStartingLineup.indexOf(homePlayerStraightRed);
          ...
          if (Math.random() < this.awayTeamPotentialFouls / 90) {
            ...
            if (Math.random() < 1 / 7) {
              ...
              if (awayPlayerCautioned.yellowCards.yellowCardsNumber == 1) {
                ...
                let indexOfCautionedPlayer =
                  this.awayTeamStartingLineup.indexOf(awayPlayerCautioned);
                this.awayTeamStartingLineup.splice(indexOfCautionedPlayer, 1);
                // decrease relative strength due to man disadvantage
                this.awayRelativeStrength =
                  this.awayRelativeStrength - this.awayRelativeStrength * 0.09;
                // decrease or increase morale after red card (50/50%)
                if (Math.random() > 0.5) {
                  this.awayTeamMorale =
                    this.awayTeamMorale - this.awayTeamMorale * 0.25;
                } else {
                  this.awayTeamMorale =
                    this.awayTeamMorale + this.awayTeamMorale * 0.05;
                }
              } else {
              ...
              if (Math.random() < 1 / 500) {
                ...
                let indexOfPlayerStraightRed =
                  this.awayTeamStartingLineup.indexOf(awayPlayerStraightRed);
                  ...
                  let awayGoalscorer =
                    this.awayTeamStartingLineup[
                      Math.round(
                        0.5 +
                          Math.random() *
                            (this.awayTeamStartingLineup.length - 1)
                      )
                    ];
